...
# 1. Create a dataset without NA ----

data_without_na <- data_complete %>% 
  filter(!is.na(Li_sp_m))

# 2. Get the number of species with back-calculated size-at-age ----

length(unique(data_without_na$Species))

# 3. Get the number of individuals with back-calculated size-at-age ----

length(unique(data_without_na$ID))

# 4. Remove useless dataset ----
