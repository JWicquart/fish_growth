...
```{r fig.width=8, fig.height=14, fig.cap="Figure 5. Comparison of growth curves by species between back-calculated data and population-level data."}
...
```{r fig.width=10, fig.height=15, fig.cap="Figure 6. Comparison of growth curves by species and location (one location only by growth curve) between back-calculated data and population-level data."}
...
ggsave("./../figs/figure-2_comparison-growth-curves-raw-vas-back-calculated.eps", height = 15, width = 10) # PDF
