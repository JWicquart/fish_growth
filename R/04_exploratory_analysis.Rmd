...
```{r fig.width=15, fig.height=30, fig.cap="Figure 1. Relation between otolith radius (Ri) and age (Agei), by species."}
...
## 2.2 Growth curves (sp. loc.)

```{r fig.width=15, fig.height=30, fig.cap="Figure 4. Growth curves by species and location."}
...
```{r fig.width=15, fig.height=30, fig.cap="Figure 5. Growth curves by species."}
...
```{r fig.width=10, fig.height=5, fig.cap="Figure 6. Comparison of growth curves by species and location (one location only by growth curve) between back-calculated data and population-level data."}
...
## 3.3 Growth curves (sp.)

```{r fig.width=8, fig.height=14, fig.cap="Figure 7. Comparison of growth curves by species between back-calculated data and population-level data."}
...
```{r fig.height=15, fig.width=30, fig.cap="Figure 8. Comparison of VBGF growth parameters estimated through Bayesian framework on species back-calculated data, with parameters from literature."}
...
```{r fig.height=10, fig.width=15, fig.cap="Figure 9. Comparison of growth curves based on VBGF growth parameters estimated through Bayesian framework on species back-calculated data with growth curves from literature."}
...
```{r fig.height=10, fig.width=9, fig.cap="Figure 10. Comparison of growth curves based on VBGF growth parameters estimated through Bayesian framework on species back-calculated data with growth curves from literature (interactive plot)."}
