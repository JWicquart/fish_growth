...
# 5. Change the radi values from 0 to NA* ----

# * If 0 the Bayesian back-calculation will find a NA for Li for the overall species or the overall species x location

data_complete <- data_complete %>% 
  mutate(radi = ifelse(radi == 0, NA, radi))
...
write.csv(data_complete, 
          "./../data/coral_reef_fishes_data.csv", 
          row.names = FALSE)
